export const getAllClaimsInfo = () => {
    return [
        {id: 101, policy_num: 129145278, customer_name: "John Smith", status: "Active", policy_type: "motor", 
        ...
        {id: 102, policy_num: 127425189, customer_name: "Maria Anders", status: "Closed", policy_type: "pet",
        ...
        {id: 103, policy_num: 121124756, customer_name: "Jane Brown", status: "Rejected", policy_type: "motor",
        ...
        {id: 104, policy_num: 125542360, customer_name: "Chris Stone", status: "Rejected", policy_type: "property",
        claim_date: "2022-05-03", estimated_value: 225, claim_reason: "window broken",
        address: "25 Elm Street, Belfast"},

        {id: 105, policy_num: 128547236, customer_name: "Alan Grey", status: "Active", policy_type: "property",
        claim_date: "2022-05-17", estimated_value: 375, claim_reason: "boiler repairs",
        address: "63 Ivy Avenue, Belfast"},

        {id: 106, policy_num: 123345178, customer_name: "Maddie Wray", status: "Active", policy_type: "pet",
        ...
        {id: 107, policy_num: 120147512, customer_name: "Carly Murray", status: "Closed", policy_type: "motor",
        ...
        {id: 108, policy_num: 127598263, customer_name: "David Cross", status: "Active", policy_type: "property",
        claim_date: "2022-05-22", estimated_value: 200, claim_reason: "damage from flood",
        address: "123 Oak Street, Lisburn"},

        {id: 109, policy_num: 124415048, customer_name: "James McHugh", status: "Closed", policy_type: "motor",
        ...
        {id: 110, policy_num: 125012698, customer_name: "Mike Peters", status: "Active", policy_type: "motor",
